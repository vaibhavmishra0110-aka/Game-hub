        ...
        <div>
            ...
            <div id="body" className="flex w-screen justify-center items-center">
                <div id="main" className="bg-blue-400 w-110 relative flex overflow-hidden"> 
                    ...
                    <img src="src/assets/flappy bird wallpaper.png" style={{ height: '100%' }} alt="img" />
                    ...
                    <div ref={bird} className='z-10 h-10 w-12 object-contain absolute top-40 translate-x-10 '>
                        <img src="src/assets/du0i1k2io4j6iveqeul81b2nme.png" alt="bird" className='overflow-hidden scale-[2] ' />
                    </div>
                    ...
                    {pipes.map(pipe => (
                        <React.Fragment key={pipe.id}>
                            ...
                            >
                                <img src="src/assets/toppng.com-flappy-bird-pipe-transparent-281x1080.png" alt="" className='h-65' />
                            </div>
                            ...
                            >
                                <img src="src/assets/opppng.com-flappy-bird-pipe-transparent-281x1080.png" alt="" className='h-65' />
                            </div>
                        </React.Fragment>
                    ))}
                </div>
